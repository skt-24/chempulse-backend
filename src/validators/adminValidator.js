...
const schemas = {
  ...
  molecule: Joi.object({
    ...
    properties: Joi.object({
      ...
      meltingPoint: Joi.string()
        .allow(''),

      boilingPoint: Joi.string()
        .allow(''),
...
const validateAdminPayload = (schemaName) => {
  return (req, res, next) => {
     ...
     *
     * This allows PATCH/PUT requests to update
